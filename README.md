# 🚀 Quanbis Computing – Android Educational App (Kotlin + Jetpack Compose)
...
[![Get it on Google Play](https://img.shields.io/badge/Download-Google_Play-green?logo=google-play&style=for-the-badge)](https://play.google.com/store/apps/details?id=org.Quanbis.computing&pcampaignid=web_share)
...
```
ui/
 ├── basics/                # Entry screens & level selection
 ├── commons/               # Reusable UI components
 ├── learning/topics/       # Core content screens
...
- Shows ability to build **offline-first, production-ready apps**  
- Highlights skills in **monetization, analytics, and component-based UI**  
- Provides a **clean and maintainable project structure**  
...
This repository is **open for public viewing**, intended for **portfolio purposes**.  
